...
type MouseParallaxProps = {
  ...
  className?: string;
  speed?: number;
  // Add any other props that MouseParallax accepts
}

const ParallaxWrapper = forwardRef<HTMLDivElement, MouseParallaxProps>(
...
<Label htmlFor="opdFees">OPD Fees</Label>
        ...
        <div className='relative'>
          <ParallaxWrapper ref={parallaxRef} className="relative z-10">
          <div className="hidden sm:block inset-0 left-90 w-[56.625rem] opacity-10 mix-blend-color-dodge pointer-events-none">
            <div className="absolute top-1/2 left-1/2 w-[58.85rem] h-[58.85rem] -translate-x-3/4 -translate-y-1/2">
              <img className="w-full" src={gradient} width={942} height={942} alt="Gradient background" />
            </div>
          </div>
        </ParallaxWrapper>
